export const validationMessages = {
  ...
  'array.required': '{{#label}} es requerido',
  ...
  'object.and':
  '{{#label}} contiene los campos {{#presentWithLabels}} pero también se requiere {{#missingWithLabels}}',
  'object.assert':
  '{{#label}} es válido porque {if(#subject.key, `"` + #subject.key + `" failed to ` + (#message || "pass the assertion test"), #message || "the assertion failed")}',
  ...
  'object.missing': '{{#label}} debe contener al menos uno de estos valores {{#peersWithLabels}}',
  'object.nand': '"{{#mainWithLabel}}" no debe existir simultáneamente con {{#peersWithLabels}}',
  'object.oxor': '{{#label}} contiene un conflicto entre campos exclusivos opcionales {{#peersWithLabels}}',
  ...
  'object.without': '"{{#mainWithLabel}}" conflicto con un campo restringido"{{#peerWithLabel}}"',
  ...
  'number.length.max': '{{#label}} debe contener  máximo {{#limit}} dígitos',
